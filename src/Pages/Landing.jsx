					...
					<section class='sticky py-24'>
						<div class='max-w-lg px-4 sm:pt-24 pt-12 sm:pb-8 mx-auto text-left md:max-w-none md:text-center'>
							<h1 class='font-extrabold  tracking-tight text-left text-[#201515] text-center sm:leading-none text-6xl sm:text-8xl'>
								<span class='inline md:block '>Jeevan - An Online Medical </span>
								<span class='relative mt-2 bg-clip-text text-[#201515] md:inline-block'>Consultation System</span>
							</h1>
						</div>
									...
									<div class='grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-24'>
										<div class='relative items-center gap-12 m-auto lg:inline-flex md:order-first'>
											<div class='max-w-xl text-center lg:text-left'>
												<div>
													<p class='text-3xl font-semibold tracking-tight text-[#201515] sm:text-5xl'>Online Medical Consultation System</p>
